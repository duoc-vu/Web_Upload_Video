...
namespace Btl_web
{
    public partial class XuLyVideoLuuTru : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (x.Id == int.Parse(Request.QueryString["oe"]))
                {
                    id = x.Id;
                    ten = x.Name;
                    chuThich = x.Detail;
                    video = x.VideoUrl;
                    glstSave.Insert(0, new Btl_web.Object.Products { Id = id, Name = ten, Detail = chuThich, VideoUrl = video });
                    Response.Redirect("ChiTietSp.aspx?id=" + id);
                }
            }
        }
    }
